...
<body>
	<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <!-- 添加 -->
		 <tr><td id="navbg33" class="left_nav_closed" ><div class="font1">工人管理</div></td></tr>
		  <tr valign="top" id="submenu33" style="display: none">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/worker/selectWorker" target="main">工人查询</a></img></p>
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/worker/addWorker?flag=1" target="main">添加工人</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  <!-- 添加end -->
